...
func (XdrAnon_Accepted_reply_Reply_data_Mismatch_info) XdrTypeName() string {
	return "XdrAnon_Accepted_reply_Reply_data_Mismatch_info"
}
func (v XdrAnon_Accepted_reply_Reply_data_Mismatch_info) XdrValue() interface{} { return v }
func (v *XdrAnon_Accepted_reply_Reply_data_Mismatch_info) XdrMarshal(x XDR, name string) {
	x.Marshal(name, v)
}
...
func XDR_XdrAnon_Accepted_reply_Reply_data_Mismatch_info(v *XdrAnon_Accepted_reply_Reply_data_Mismatch_info) *XdrAnon_Accepted_reply_Reply_data_Mismatch_info {
	return v
}
...
func (XdrAnon_Accepted_reply_Reply_data) XdrTypeName() string {
...
func XDR_XdrAnon_Accepted_reply_Reply_data(v *XdrAnon_Accepted_reply_Reply_data) *XdrAnon_Accepted_reply_Reply_data {
	return v
}
...
func (XdrAnon_Rejected_reply_Mismatch_info) XdrTypeName() string {
	return "XdrAnon_Rejected_reply_Mismatch_info"
}
...
func XDR_XdrAnon_Rejected_reply_Mismatch_info(v *XdrAnon_Rejected_reply_Mismatch_info) *XdrAnon_Rejected_reply_Mismatch_info {
	return v
}
