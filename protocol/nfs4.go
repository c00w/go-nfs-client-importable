...
func (v *Layoutiomode4) XdrInitialize() {
	...
	default:
		if *v == Layoutiomode4(0) {
			*v = LAYOUTIOMODE4_READ
		}
	}
}
...
func (v *Callback_sec_parms4) XdrInitialize() {
	...
	case AUTH_NONE, AUTH_SYS:
	default:
		if v.Cb_secflavor == zero {
			v.Cb_secflavor = uint32(AUTH_NONE)
		}
	}
}
...
func (v *_XdrVec_unbounded_Callback_sec_parms4) XdrPointer() interface{} {
	return (*[]Callback_sec_parms4)(v)
}
func (v _XdrVec_unbounded_Callback_sec_parms4) XdrValue() interface{} {
	return ([]Callback_sec_parms4)(v)
}
...
func (GET_DIR_DELEGATION4res_non_fatal) XdrTypeName() string {
...
func XDR_GET_DIR_DELEGATION4res_non_fatal(v *GET_DIR_DELEGATION4res_non_fatal) *GET_DIR_DELEGATION4res_non_fatal {
	return v
}
...
func (v *Layoutreturn_type4) XdrInitialize() {
	...
	default:
		if *v == Layoutreturn_type4(0) {
			*v = LAYOUTRETURN4_FILE
		}
	}
}
